...
(() => {
  ...
  /* Mobile nav is owned by components/layout/Navbar.tsx (React state).
     The old #nav-hamburger / #nav-drawer markup no longer exists. */
  ...
  /* ── GENERAL REVEAL OBSERVER (handled in page.tsx) ─ */
